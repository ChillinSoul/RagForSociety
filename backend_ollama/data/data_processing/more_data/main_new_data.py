...
prompt_template = PromptTemplate(
    ...
    template="""Écris un résumé pour ce texte dans le contexte de fournir le plus d'informations possible sur un certain sujet à un utilisateur.
      ...
      Tu dois impérativement réécrire tout ce qui est données chiffrées dans to résumé.
      ...
      Ne jamais intégrer les liens qui ne sont pas des liens complets !!
...
def main():
    input_file = "sécurité_sociale/cleaned_markdown_pages.json"  # Update this to your new input file
    output_file = "sécurité_sociale/sécurité_sociale_summarized.json"
