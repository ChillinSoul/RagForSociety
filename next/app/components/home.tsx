  ...
  return (
    <div className="w-full h-full relative" >
      ...
      {(responseMutation.isSuccess || responseBNFMutation.isSuccess) && showResponse &&!questionaireAnswered && (
        ...
        {(responseMutation.isPending || responseBNFMutation.isPending) &&<div className="mx-8"> <progress className="progress"></progress> </div>}
      <QueryBar query={query} setQuery={setQuery} handleSubmit={handleSubmit} responseMutation={responseMutation} responseBNFMutation={responseBNFMutation}/>
    </div>
  )
}
